...
import { PromiseStyle } from "./promise-style.js";
            ...
            >
              <div className="item">
                <svg
                  ...
                  class="svg-inline--fa fa-laptop-code fa-2xl "
                  role="img"
              ...
              <div className="element__content">
                ...
                solutions. You receive W3C fully compliant markup.
              </div>
            </div>
            ...
            >
              <div className="item">
                <svg
                  ...
                  class="svg-inline--fa fa-tablet-screen-button fa-2xl "
                  role="img"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 448 512"
                  color="#efaf4b"
              ...
              <div className="element__content">
                We understand the value of timely responsiveness and
                adaptability.
              </div>
            </div>
            ...
            >
              <div className="item">
                <svg
                  ...
                  class="svg-inline--fa fa-people-group fa-2xl "
                  role="img"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 640 512"
                  color="#00bdeb"
              ...
              <div className="element__content">
                You'll have access to an all-star team of experienced
                professionals.
              </div>
            </div>
            ...
            >
              <div className="item">
                <svg
                  ...
                  class="svg-inline--fa fa-diamond-turn-right fa-2xl "
                  role="img"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                  color="#864AF9"
              ...
              <div className="element__content">
                We are swift and capable of providing high-quality code fast.
              </div>
            </div>
            ...
            >
              <div className="item">
                <svg
                  ...
                  data-prefix="far"
                  data-icon="life-ring"
                  class="svg-inline--fa fa-life-ring fa-2xl "
                  role="img"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                  color="#fc2947"
              ...
              <div className="element__content">
                If bugs emerge in the future, feel free to reach out for
                support.
              </div>
            </div>
            ...
            >
              <div className="item">
                <svg
                  ...
                  class="svg-inline--fa fa-shield-halved fa-2xl "
                  role="img"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                  color="#32c766"
              ...
              <div className="element__content">
                You own the creative work entirely — NDA guaranteed.
              </div>
            </div>
          </div>
        </div>
